/** @file
 *
 *  Static SMBIOS Table for the ROC-RK3568-PC platform
...
CHAR8 *mOemStringsType11Strings[] = {
  "https://en.t-firefly.com/product/industry/rocrk3568pc.html",
  NULL
};
  ...
  )
{
  ...
  AsciiStrCpyS (mSysInfoManufName, sizeof (mSysInfoManufName), "Firefly");
