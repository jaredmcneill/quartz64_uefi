...
[Defines]
  ...
  BOARD_DXE_FV_COMPONENTS        = Platform/Luckfox/Core3566/Core3566.fdf.inc
...
[PcdsFixedAtBuild.common]
  ...
  gRk356xTokenSpaceGuid.PcdPlatformName|"Luckfox Core3566"
  gRk356xTokenSpaceGuid.PcdCpuName|"Rockchip RK3566 (Cortex-A55)"
  gRk356xTokenSpaceGuid.PcdPlatformVendorName|"Firefly"
  gRk356xTokenSpaceGuid.PcdFamilyName|"Core3566"
  gRk356xTokenSpaceGuid.PcdProductUrl|"https://wiki.luckfox.com/Core3566/"
  ...
  #
  # RTC support (hym8563 at 0x51 on I2C1)
  #
  gRk356xTokenSpaceGuid.PcdRtcI2cBusBase|0xFE5A0000
...
[Components.common]
  ...
  # Board specific
  #
  Platform/Luckfox/Core3566/Drivers/BoardInitDxe/BoardInitDxe.inf
