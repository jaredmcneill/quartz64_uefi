...
[Defines]
  ...
  BOARD_DXE_FV_COMPONENTS        = Platform/Pine64/PineTab2/PineTab2.fdf.inc
...
[BuildOptions]
  GCC:*_*_*_CC_FLAGS          = -DRK356X -DPINETAB2
  GCC:*_*_*_PP_FLAGS          = -DRK356X -DPINETAB2
  GCC:*_*_*_ASLPP_FLAGS       = -DRK356X -DPINETAB2
  GCC:*_*_*_ASLCC_FLAGS       = -DRK356X -DPINETAB2
  GCC:*_*_*_VFRPP_FLAGS       = -DRK356X -DPINETAB2
...
[PcdsFixedAtBuild.common]
  ...
  gRk356xTokenSpaceGuid.PcdPlatformName|"PINE64 PineTab2"
  gRk356xTokenSpaceGuid.PcdCpuName|"Rockchip RK3566 (Cortex-A55)"
  gRk356xTokenSpaceGuid.PcdPlatformVendorName|"Pine64"
  gRk356xTokenSpaceGuid.PcdFamilyName|"PineTab2"
  gRk356xTokenSpaceGuid.PcdProductUrl|"https://www.pine64.org/pinetab2/"
...
[Components.common]
  ...
  # Board specific
  #
  Platform/Pine64/PineTab2/Drivers/BoardInitDxe/BoardInitDxe.inf
